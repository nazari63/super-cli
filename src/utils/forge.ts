...
export type CompilerOutputSource = {
    keccak256: Hash
    urls: string[]
    license: string
}
...
export function readForgeArtifact(artifactPath: string): ForgeArtifact {
    ...
    if (!artifactJSON.metadata || !artifactJSON.metadata.sources || !artifactJSON.metadata.compiler || !artifactJSON.metadata.version) {
